        ...
        <div className="flex gap-[20px] h-full mx-auto max-w-[1230px] border-solid border-b-[1px] border-[#dae1e7]">
          ...
          <div className="w-[25%] px-[15px] pb-[30px]">
            ...
            <ul className='text-[14px] text-[#a4a4a4]'>
              ...
              <li className='flex gap-[10px] mb-[6px] list-none'>
                <FontAwesomeIcon className='text-white/75 text-[18px] mt-[5px]' icon={faPhoneAlt} />
                <p><a className='hover:text-primary transition-all' href="tel:0912316304">0912316304</a></p>
              </li>
              <li className='flex gap-[10px] mb-[6px] list-none'>
          ...
          <div className="w-[25%] px-[15px] pb-[30px]">
            ...
            <ul className='text-[14px] text-[#a4a4a4]'>
              ...
              <Social color={'#2478ba'} icon={faTwitter} href="https://fb.com/duchaudeyy" />
              <Social color={'#ff0303'} icon={faYoutube} href="https://fb.com/duchaudeyy" />
            </ul>
          </div>
