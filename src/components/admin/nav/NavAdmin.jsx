...
const NavAdmin = () => {
  ...
  return (
    <div className="rounded-tl-[12px] rounded-bl-[12px] p-[20px] pt-0 w-[270px] shadow-xl">
      ...
      <ul className='w-full'>
        <NavActive to='home' icon={faHome} text='Báo cáo bán hàng' />
        <NavActive to='view-users' icon={faUsers} iconSize='text-[18px]' text='Quản lý người dùng' />
        ...
        <NavActive to='view-orders/view' icon={faFolder} text='Quản lý đơn hàng' />
      </ul>
    </div>
  );
};
